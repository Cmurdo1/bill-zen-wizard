...
const description =
  "Create a professional invoice online for free. Add your client, services, prices, and payment details, then send it with Honest Invoice.";
        ...
        <div className="container-page py-16 sm:py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-muted-foreground">
              Start with the simple version: add the client, describe the work, review the totals,
              and send. When you want AI-assisted line items and saved billing workflows, create a
              free Honest Invoice account.
            </p>
