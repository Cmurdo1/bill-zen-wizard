  ...
  head: ({ loaderData, params }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `https://honestinvoice.com/blog/${params.slug}` },
        { property: "og:image", content: "https://honestinvoice.com/og.png" },
        { property: "article:published_time", content: post.date },
        { property: "article:author", content: post.author },
      ],
      links: [{ rel: "canonical", href: `https://honestinvoice.com/blog/${params.slug}` }],
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            url: `https://honestinvoice.com/blog/${params.slug}`,
            mainEntityOfPage: `https://honestinvoice.com/blog/${params.slug}`,
            image: "https://honestinvoice.com/og.png",
