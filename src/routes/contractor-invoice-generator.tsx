...
const description =
  "Create professional contractor invoices online for free. Turn job details into clear labor and material line items, then send an invoice with Honest Invoice.";
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: `${SITE_URL}/contractor-invoice-generator`,
    ...
    <MarketingShell>
        ...
        <div className="container-page py-16 sm:py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-3 font-display text-5xl tracking-tight text-foreground sm:text-6xl">
              Create a contractor invoice in minutes.
            </h1>
            <p className="mt-5 text-lg leading-8 text-muted-foreground">
              Start with the job: add the client, describe the work, review labor and materials, and
              send a professional invoice. When you want AI-assisted line items and saved billing
              workflows, create a free Honest Invoice account.
            </p>
      ...
      <section className="py-16">
        <div className="container-page rounded-3xl bg-primary-gradient p-10 text-center text-primary-foreground">
          <h2 className="font-display text-4xl">Need invoices for every job?</h2>
          <p className="mt-3 text-primary-foreground/80">
            Create a free account and keep your clients, rates, estimates, and invoices together.
          </p>
          <Link
            to="/signup"
