...
const FEATURES = [
  ...
  },
  {
    ...
    body: "Pro and Business plans include MCP access so your AI agent can create and send estimates from your associated account.",
  },
  {
    icon: Repeat,
...
const STEPS = [
  ...
  },
  {
    ...
    body: "Type it like you'd tell a friend. AI turns it into itemized labor and materials.",
  },
  {
    n: "03",
...
const AUDIENCES = [
  { label: "Contractors", to: "/invoice-software-for-contractors" },
  { label: "Freelancers", to: "/invoice-software-for-freelancers" },
  { label: "Small businesses", to: "/invoice-software-for-small-business" },
  { label: "HVAC contractors", to: "/invoice-software/hvac" },
  { label: "Electricians", to: "/invoice-software/electricians" },
  { label: "Plumbers", to: "/invoice-software/plumbers" },
  { label: "Landscapers", to: "/invoice-software/landscapers" },
  { label: "Cleaners", to: "/invoice-software/cleaners" },
  { label: "Photographers", to: "/invoice-software-for-freelancers" },
  { label: "Consultants", to: "/invoice-software-for-freelancers" },
];

const FAQS = [
  {
    q: "Is there really a free plan?",
    a: "Yes. Send up to 5 invoices a month on the free plan, forever. No credit card required.",
  },
  {
  ...
  },
  {
    ...
    a: "We calculate and display tax on invoices, but filing is your responsibility. Talk to an accountant.",
  },
];
        ...
        <div className="container-page grid gap-12 py-20 lg:grid-cols-[1.15fr_1fr] lg:py-28">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-surface px-3 py-1 text-xs font-medium text-muted-foreground shadow-soft">
              <Sparkles className="h-3.5 w-3.5 text-accent" /> AI-powered invoicing, built for real
              work
            </span>
        ...
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((f) => (
              <div
                key={f.title}
                className="rounded-2xl border border-border bg-surface p-6 shadow-soft transition-shadow hover:shadow-lifted"
              >
        ...
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {STEPS.map((s) => (
              <div
                key={s.n}
                className="relative rounded-2xl border border-border bg-surface p-8 shadow-soft"
              >
          ...
          <div className="mx-auto mt-10 flex max-w-3xl flex-wrap justify-center gap-2">
            {AUDIENCES.map((a) => (
              <Link
                key={a.label}
                to={a.to}
                className="rounded-full border border-border bg-surface px-4 py-2 text-sm font-medium text-foreground shadow-soft transition-colors hover:border-primary/40 hover:text-primary"
              >
                {a.label}
              </Link>
            ))}
        ...
        <div className="container-page">
          <div className="overflow-hidden rounded-3xl bg-primary-gradient p-10 text-center text-primary-foreground shadow-lifted sm:p-16">
            ...
            <p className="mt-3 text-primary-foreground/80">
              Start free. Send your first invoice in two minutes.
            </p>
            <Link
              to="/signup"
